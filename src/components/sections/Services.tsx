        ...
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className={`group relative overflow-hidden rounded-2xl border border-white/5 bg-white/5 p-8 backdrop-blur-sm transition-all duration-300 hover:border-accent/50 ${
            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col">
                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-white/5 shadow-[0_0_15px_rgba(var(--accent-rgb),0.2)] group-hover:shadow-[0_0_25px_rgba(var(--accent-rgb),0.5)] transition-shadow duration-300">
                ...
                <div className="mt-auto pt-8">
                  <a href="#contact" className="inline-flex items-center text-sm font-medium text-accent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
